 ...
 * ====================================================================
 *
 * Read JPEG 2000 and write PNG image.
 */
...
int test_node_imageio_j2k(const bool debug_print,
                      std::shared_ptr<ocg::Cache> cache) {
    if (debug_print) {
        std::cout << "======================= test_node_imageio_j2k()" << '\n';
    }
    ...
    graph.set_node_attr_str(
        read1_node, "file_path", "./tests/data/openjpeg-images/input/conformance/file1.jp2");
    graph.set_node_attr_str(
        read2_node, "file_path", "./tests/data/openjpeg-images/input/conformance/file2.jp2");
    graph.set_node_attr_str(
        read3_node, "file_path", "./tests/data/openjpeg-images/input/conformance/file5.jp2");
    graph.set_node_attr_str(
        read4_node, "file_path", "./tests/data/openjpeg-images/input/conformance/file9.jp2");
    graph.set_node_attr_str(
        read5_node, "file_path", "./tests/data/openjpeg-images/input/conformance/p0_14.j2k");

    graph.set_node_attr_str(
        write1_node, "file_path", "./tests/data/out/test_node_imageio_j2k_out1.png");
    graph.set_node_attr_str(
        write2_node, "file_path", "./tests/data/out/test_node_imageio_j2k_out2.png");
    graph.set_node_attr_str(
        write3_node, "file_path", "./tests/data/out/test_node_imageio_j2k_out3.png");
    graph.set_node_attr_str(
        write4_node, "file_path", "./tests/data/out/test_node_imageio_j2k_out4.png");
    graph.set_node_attr_str(
        write5_node, "file_path", "./tests/data/out/test_node_imageio_j2k_out5.png");
